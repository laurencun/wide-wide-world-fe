...
class Signup extends Component {
    ...
    render() {
        ...
        <Flex flexWrap='wrap'>
            <Box style={{marginTop:'30vh', border:'1px solid black', backgroundColor:'#fff', padding:'20px', width:'100vw', justifyContent:'center', justifyItems:'center', textAlign:'center'}}>
